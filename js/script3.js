...
async function playStream(url, retry = false, skipUpdateUrl = false) {
    ...
    playerSpinner(false, "Loading Stream...");
...
(async () => {
    ...
    if (!playlistBar) {
        ...
        playlistBar.style = "width: 95%; text-align: center; font-weight: 600; padding: 8px 0px; background: rgba(88, 89, 91, 0.19); color: rgb(23, 162, 184); border-bottom: 1.5px solid rgb(17, 17, 17); margin-left: 13px;background: #18191a;background: linear-gradient(90deg, rgba(24, 25, 26, 0.58) 0%, rgba(104, 110, 106, 0.54) 50%, rgba(23, 23, 22, 0.64) 100%);border-radius: 6px;margin-bottom: 4px;margin-left: 22px;";
