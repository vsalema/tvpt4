...
{ name: 'XXX', url: 'https://raw.githubusercontent.com/vsalema/tvpt4/refs/heads/main/css/XXXTV.m3u' },
...
function parseM3UContent(m3uText) {
  ...
  for (let i = 0; i < lines.length; i++) {if (window.CP.shouldStopExecution(0)) break;if (window.CP.shouldStopExecution(0)) break;
